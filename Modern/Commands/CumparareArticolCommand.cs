...
{
    public class CumparareArticolCommand : Commandbase
    {

        InventarViewModel _inventarviewmodel;

        public CumparareArticolCommand(InventarViewModel inventarviewmodel)
        {
        ...
        public override void Execute(object parameter)
        {
            ...
            using (Bazadateconnect bz = new Bazadateconnect())
            {
                ...
                {
                    Descriere = $"Cumparare {cantitate} bucati din {_inventarviewmodel.SelectedArticol.denumire}",
                    Data = DateTime.Now,
                    Suma = _inventarviewmodel.SelectedArticol.pretcumparare * cantitate,
                    EVenit = false,
                };
